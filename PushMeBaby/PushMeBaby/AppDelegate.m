...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (IOS8_10){
        ...
        UNNotificationAction *action1 = [UNNotificationAction actionWithIdentifier:@"action2" title:@"查看消息" options:UNNotificationActionOptionForeground];
        UIMutableUserNotificationCategory * category1 = [[UIMutableUserNotificationCategory alloc] init];
        category1.identifier = @"alert1";
...
// 在前台会自动走这些, 在后台点击(通知)之后才会走
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler {
    NSLog(@"iOS7及以上系统，收到通知:%@", userInfo);
    
    [[NSNotificationCenter defaultCenter]postNotificationName:@"TESTPUSH" object:nil userInfo:userInfo];
